...
public class MainFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Click"))
		{
			...
			boolean gotNewImage = myFrame.capture("src/NavCam/moduleNavCamClick/resources/ClickedImages/LeftTop.jpg");
			
			if (gotNewImage) {
				File tmpFile = new File("src/NavCam/moduleNavCamClick/resources/ClickedImages/LeftTop.jpg");	
	        ...
	        boolean gotNewImage2 = myFrame.capture("src/NavCam/moduleNavCamClick/resources/ClickedImages/RightTop.jpg");
			...
			try {
			  ...
			  boolean gotNewImage3 = myFrame.capture("src/NavCam/moduleNavCamClick/resources/ClickedImages/LeftDown.jpg");
				
				if (gotNewImage3) {
					File tmpFile = new File("src/NavCam/moduleNavCamClick/resources/ClickedImages/LeftDown.jpg");	
			...
			try {
			 ...
			 boolean gotNewImage4 = myFrame.capture("src/NavCam/moduleNavCamClick/resources/ClickedImages/RightDown.jpg");
				
				if (gotNewImage4) {
					File tmpFile = new File("src/NavCam/moduleNavCamClick/resources/ClickedImages/RightDown.jpg");	
